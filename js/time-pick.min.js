var TimePick = (function () {
  ...
  return function (e) {
    var t,
      i = { set_hour: {}, set_minute: {}, set_second: {} };
    null == document.getElementById('TimePickStyleSheet') &&
    ...
    for (var o = 0; o < i.elemets.length; o++) {
      ...
      if (
        ...
        let e = i.elemets[o].value.split(':'),
          t = n + '_' + o;
        (document.getElementById('label_hour_' + t).innerText = e[0]),
          (document.getElementById('label_minute_' + t).innerText = e[1]),
          (document.getElementById('label_second_' + t).innerText = e[2]);
      } else i.elemets[o].setAttribute('value', '00:00:00');
    }
    let r = document.getElementsByClassName('TimePick_ICON');
    for (let e = 0; e < r.length; e++)
      r[e].onclick = function () {
        let t = 'popup_' + r[e].id;
        'flex' != document.getElementById(t).style.display
          ? (document.getElementById(t).style.display = 'flex')
          : (document.getElementById(t).style.display = 'none');
      };
    document.onclick = function (e) {
      if ('TimePickBackgroundOverlay' == e.target.id) {
        let e = document.getElementsByClassName('TimePick_POPUP');
        for (let t = 0; t < e.length; t++) e[t].style.display = 'none';
      }
    };
    let d = document.getElementsByClassName('adjustbtn');
    for (let e = 0; e < d.length; e++)
      d[e].onclick = function () {
        let t = JSON.parse(d[e].getAttribute('data')),
          n = document.getElementById('label_hour_' + t.id).innerText,
          o = document.getElementById('label_minute_' + t.id).innerText,
          r = document.getElementById('label_second_' + t.id).innerText;
        '00' != n && (i.set_hour[t.id] = parseInt(n)),
          '00' != o && (i.set_minute[t.id] = parseInt(o)),
          '00' != r && (i.set_second[t.id] = parseInt(r)),
          'hour' == t.type &&
            'up' == t.action &&
            ((i.set_hour[t.id] = i.set_hour[t.id] ? i.set_hour[t.id] + 1 : 1),
            (i.set_hour[t.id] = 24 == i.set_hour[t.id] ? 0 : i.set_hour[t.id])),
          'hour' == t.type &&
            'down' == t.action &&
            ((i.set_hour[t.id] = i.set_hour[t.id] ? i.set_hour[t.id] - 1 : -1),
            (i.set_hour[t.id] =
              -1 == i.set_hour[t.id] ? 23 : i.set_hour[t.id])),
          'minute' == t.type &&
            'up' == t.action &&
            ((i.set_minute[t.id] = i.set_minute[t.id]
              ? i.set_minute[t.id] + 1
              : 1),
            (i.set_minute[t.id] =
              60 == i.set_minute[t.id] ? 0 : i.set_minute[t.id])),
          'minute' == t.type &&
            'down' == t.action &&
            ((i.set_minute[t.id] = i.set_minute[t.id]
              ? i.set_minute[t.id] - 1
              : -1),
            (i.set_minute[t.id] =
              -1 == i.set_minute[t.id] ? 59 : i.set_minute[t.id])),
          'second' == t.type &&
            'up' == t.action &&
            ((i.set_second[t.id] = i.set_second[t.id]
              ? i.set_second[t.id] + 1
              : 1),
            (i.set_second[t.id] =
              60 == i.set_second[t.id] ? 0 : i.set_second[t.id])),
          'second' == t.type &&
            'down' == t.action &&
            ((i.set_second[t.id] = i.set_second[t.id]
              ? i.set_second[t.id] - 1
              : -1),
            (i.set_second[t.id] =
              -1 == i.set_second[t.id] ? 59 : i.set_second[t.id]));
        let s =
            null == i.set_hour[t.id]
              ? '00'
              : i.set_hour[t.id] < 10
              ? '0' + i.set_hour[t.id]
              : i.set_hour[t.id],
          l =
            null == i.set_minute[t.id]
              ? '00'
              : i.set_minute[t.id] < 10
              ? '0' + i.set_minute[t.id]
              : i.set_minute[t.id],
          a =
            null == i.set_second[t.id]
              ? '00'
              : i.set_second[t.id] < 10
              ? '0' + i.set_second[t.id]
              : i.set_second[t.id];
        (document.getElementById('label_hour_' + t.id).innerText = s),
          (document.getElementById('label_minute_' + t.id).innerText = l),
          (document.getElementById('label_second_' + t.id).innerText = a),
          (document.querySelectorAll(
            'input[TimePick=input_' + t.id + ']'
          )[0].value = s + ':' + l + ':' + a);
      };
    return i;
  };
