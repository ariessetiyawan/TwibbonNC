...
(function (a) {
  ...
  if (c && !c.prototype.toBlob) {
    c.prototype.toBlob = function (n, l) {
      if (!l) {
        l = 'image/png';
      }
      if (this.mozGetAsFile) {
        n(this.mozGetAsFile('canvas', l));
        return;
      }
      var k = Array.prototype.slice.call(arguments, 1),
        i = this.toDataURL.apply(this, k),
        h = i.indexOf(','),
        m = i.substring(h + 1),
        g = d.test(i.substring(0, h)),
        j;
      if (Blob.fake) {
        j = new Blob();
        if (g) {
        ...
        if (b) {
          if (g) {
            j = new Blob([e(m)], { type: l });
          } else {
            j = new Blob([decodeURIComponent(m)], { type: l });
          }
        }
      }
      n(j);
